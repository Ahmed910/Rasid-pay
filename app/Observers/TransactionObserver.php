        ...
        $transaction_details =
            [
                ...
                'wallet_transfer'  => $transaction->trans_type == "wallet_transfer"
                    ? trans_choice("mobile.transaction.transaction_details.wallet_transfer_status", $transaction->transactionable?->wallet_transfer_method,  ['amount' => $transaction->amount, 'to_user_identity_or_mobile_or_wallet_number' => @$wallet_transfer_method[$transaction->transactionable?->wallet_transfer_method]])
                    : "",
