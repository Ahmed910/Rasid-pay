...
class CitizenResource extends JsonResource
{
    public function toArray($request)
    {
        return [
            ...
            'enabled_card' => $this->enabledCard ? trans('dashboard.citizens.card_type.'.$this->enabledCard?->card_type) : trans('dashboard.citizens.without'),
            'card_end_at' => $this->enabledCard?->end_at ?? trans('dashboard.citizens.without'),
