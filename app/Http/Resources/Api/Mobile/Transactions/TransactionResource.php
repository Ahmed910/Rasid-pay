...
//                'payment' => $this->trans_type == "payment" ? trans("mobile.transaction.transaction_details.payment_status", ['amount' => number_format($this->amount, 2, '.', ''), 'refund_amount' => number_format($this->amount, 2, '.', '')]) : "",
        ...
        return [
            ...
            'wallet_transfer_value' => $this->when($this->trans_type == 'wallet_transfer', (string)$wallet_transfer_method[$this->transactionable?->wallet_transfer_method] ?? (string)$this->toUser?->citizenWallet?->wallet_number),
