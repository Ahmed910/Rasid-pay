    ...
    public function toArray($request)
    {
        ...
        $transaction_details =
            [
                ...
                'charge' => $this->trans_type == "charge" ? trans("mobile.transaction.transaction_details.charge_status", ['amount' => number_format($this->amount, 2, '.', ''), 'method' => __('mobile.transaction.charge_types.'.$this->transactionable?->charge_type,  [ 'card_number' => addCharBetweenChunks(Str::mask($this->card_number, '*', 0,-4),4) ])]) : "",
