...
namespace App\Http\Resources\Api\V1\Dashboard\RasidJob;

use App\Http\Resources\Api\V1\Dashboard\{ActivityLogResource, GlobalTransResource, SimpleEmployeeResource, SimpleUserResource};
