...
class ForgotPasswordController extends Controller
{
    ...
    */
    ...
    private function sendSmsCode($request)
    {
        ...
        $mask_number =  '(+996)' . str_repeat("*", strlen($user->phone)-4) . substr($user->phone, -3);
        return response()->view('dashboard.auth.verify_code',['reset_token' => $reset_token, 'phone' => $mask_number]);
    }
