...
class JobController extends Controller
{
    ...
    public function store(RasidJobRequest $request, RasidJob $rasidJob)
    {
        ...
        return redirect()->route('dashboard.jobs.index')->with('success', __('dashboard.general.success_add'));
    }
    ...
    $rasidJob->fill($request->validated() + ['updated_at' => now()])->save();
        ...
        return redirect()->route('dashboard.jobs.index')->with('success', __('dashboard.general.success_update'));
    }
