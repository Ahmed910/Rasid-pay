...
<form method="get" action="">
  <div class="row align-items-end mb-3">
    ...
    <div class="col-12 col-md-3">
      ...
      {!! Form::select('main_program',$mainPrograms,null,['class'=>'form-control select2-show-search form-select', 'id'=>'mainProgram','placeholder'=> trans('dashboard.activity_log.select_mainprogram') ]) !!}

    </div>
    <div class="col-12 col-md-3 mt-3">
      <label for="branchProgram"> {{ trans('dashboard.activity_log.sub_program') }}</label>
      {!! Form::select('sub_program',trans('dashboard.activity_log.sub_progs'),null,['class'=>'form-control select2-show-search form-select', 'id'=>'branchProgram','placeholder'=> trans('dashboard.activity_log.select_subprogram') ]) !!}
