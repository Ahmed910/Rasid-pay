...
@section('image')
    ...
    <h1 class="display-1 mb-2">
        4<span class="custom-emoji"><svg xmlns="http://www.w3.org/2000/svg" height="140" width="140" data-name="Layer 1"
                viewBox="0 0 24 24">
...
@endsection
@section('message', 'Sorry, an error has occured, Requested page not found!')
