          ...
          <div class="container text-center">
            <div class="error-template">
              <h1 class="display-1 mb-2">
                4<span class="text-center custom-emoji"
                  ><svg
                  ...
                  >
                    ...
                    />
                    <rect width="4" height="2" x="10" y="14" fill="#862a87" />
                    <path
                      fill="#862a87"
              ...
              <div class="m-5">
                <span class="fs-20"> OOPS! Page not found </span>
                <p>Sorry, an error has occured, Requested page not found!</p>
              </div>
              <div class="text-center">
                <a class="btn btn-primary mt-5 mb-5" href="index.html">
