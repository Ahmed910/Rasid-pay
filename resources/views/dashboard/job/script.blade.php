      ...
      $("#JobsTable").DataTable({
        ...
        columns: [{
          ...
          },
          {
            data: function (data) {
              if (data.department_name !== null) {
                return `<div class="d-flex align-items-center"><div class="flex-shrink-0"> <img src="${data.department_image}" width="25" class="avatar brround cover-image" alt="..." data-toggle="popoverIMG" /> </div><div class="flex-grow-1 ms-3">${data.department_name}</div>`
              }
            }
          },
          {
          ...
          },
          {
            class: "text-center",
            data: function (data) {
              fun_modal = !data.is_vacant ? `notArchiveItem('@lang('dashboard.rasid_job.jobs_hired_archived')')` :
