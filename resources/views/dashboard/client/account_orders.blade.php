...
<form method="get" action="">
  <div class="row align-items-end mb-3">
    <div class="col-12 col-md-4 mb-3">
      <label for="clientName">رقم الطلب</label>
      <input type="number" class="form-control" id="clientName" placeholder="رقم الطلب" />
    </div>
    <div class="col-12 col-md-4 mb-3">
    ...
    <div class="col-12 col-md-4 mb-3">
      <label for="bankStatus">حالة الطلب</label>
  ...
  <div class="col-lg-12">
    <div class="p-1">
      <table id="historyTable" class="table table-bordered shadow-sm bg-body text-nowrap key-buttons">
        <thead>
          <tr>
            <th class="border-bottom-0">#</th><th class="border-bottom-0">رقم الطلب</th>
