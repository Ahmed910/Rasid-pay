...
<div class="repeater">
  ...
  <fieldset class="card createBankBranch px-4 py-4 " id="bankbranch">
    <a role="button" href="javascript:void(0)" class="deleteBranch text-end "><i class="mdi mdi-delete  "></i></a>
    <div class="row">
      ...
      <div class="col-12 col-md-4 mb-5">
        ...
        <span class="requiredFields">*</span>
        {!! Form::select("branches[$key][type]",[''=>'']+trans('dashboard.bank.types'),null,['class' => 'form-control
        select2' . ($errors->has("branches.$key.name") ? ' border-danger' : null), 'id' => 'bankType',
        'data-placeholder' => trans('dashboard.general.select_type')]) !!}
...
<div class="row">
  <div class="col-12 mb-5 text-end">
    {!! Form::button('<i class="mdi mdi-content-save-outline"></i>' . trans('dashboard.general.save'), ['type' => 'submit', 'class' => 'btn btn-primary', 'id' => 'saveButton']) !!}
      {!! Form::button('<i class="mdi mdi-arrow-left"></i>' . trans('dashboard.general.back'), ['type' => 'button', 'class' => 'btn btn-outline-primary showBack']) !!}
