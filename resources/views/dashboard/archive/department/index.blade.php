...
<form method="get" action="" id="search-form">
  <div class="row align-items-end mb-3">
    ...
    <div class="col-12 col-md-4">
      ...
      trans('dashboard.department.without_parent')] + $parentDepartments, request('parent_id'), ['class' =>
    ...
    <div class="col-12 col-md-4">
      ...
      trans('dashboard.department.active_cases'), old('is_active') ?? request('is_active'), ['class' => 'form-control
      ...
      <div class="dropdown">
        ...
        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
            <li><a class="dropdown-item"
                            href="{{ url(app()->getLocale().'/dashboard/department/archive/exportPDF')  }}?{{ http_build_query(request()->query()) }}"
                            target="_blank">PDF</a></li>
                    <li><a class="dropdown-item"
                            href="{{ url(app()->getLocale().'/dashboard/department/archive/export') }}?{{ http_build_query(request()->query()) }}"
