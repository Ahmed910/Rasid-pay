  ...
  <form method="get" action="" id="search-form">
    <div class="row align-items-end mb-3">
      <div class="col">
        ...
        {!! Form::text('name', old('name') ?? request('name'), ['class' => 'form-control stop-copy-paste', 'placeholder' => trans('dashboard.rasid_job.job_name'), 'id' => 'job_name' , 'pattern'=>"^[a-zA-Z0-9]+$"]) !!}
      </div>
      <div class="col">
      ...
      <div class="col">
        ...
        <div class="input-group">
          ...
          {!! Form::text('delted_to', old('delted_to') ?? request('delted_to'), ['class' => 'form-control', 'placeholder' => trans('dashboard.general.day_month_year'), 'id' => 'to-hijri-picker-custom', 'readonly']) !!}
