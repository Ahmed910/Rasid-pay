...
<div class="modal fade" id="modal_un_archive">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0">
            <form method="post" action="#" class="needs-validation validForm" id="items" novalidate>@csrf
                <div class="modal-body text-center p-0">
                    ...
                    <div class="mt-3">
                        <textarea name="reasonAction" class="form-control input-regex stop-copy-paste reasonAction" placeholder="الرجاء ذكر السبب*" rows="3" 
                            required></textarea>
                ...
                <div class="modal-footer justify-content-center mt-5 p-0">
                    ...
                    <button type="button" class="btn btn-outline-success closeBtn"  data-bs-dismiss="modal" >
