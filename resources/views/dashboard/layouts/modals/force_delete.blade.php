...
<div class="modal fade" id="modal_force_delete">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0">
            <form method="post" action="#" class="needs-validation validForm" id="item" novalidate>@csrf
                @method('delete')
          ...
          style=" width: 55%; display: block; margin: 0 auto 1em">
                ...
                <div class="mt-3">
                    <textarea class="form-control input-regex stop-copy-paste reasonAction" placeholder="{{ trans('dashboard.general.reason_needed') }}"
                        rows="3" name="reasonAction"  required></textarea>
                ...
                <div class="modal-footer justify-content-center mt-5 p-0">
                    ...
                    <button type="button" class="btn btn-outline-danger closeBtn" data-bs-dismiss="modal">
