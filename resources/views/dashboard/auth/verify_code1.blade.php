...
<form method="POST" action="{!! route('dashboard.check_sms_code') !!}" class="needs-validation" id="form_sms" novalidate>
  ...
  <div class="row col-12 col-md-8 m-auto" dir="ltr">
    <div class="col">
      <input type="text" oninput='digitValidate(this)' onkeyup='tabChange(1)' class="form-control text-center   @error('reset_code') border-danger @enderror" name="reset_code[]"
      required
      maxlength="1"
      />
    </div>
    <div class="col">
      <input type="text" oninput='digitValidate(this)' onkeyup='tabChange(2)' class="form-control text-center   @error('reset_code') border-danger @enderror" name="reset_code[]"
      required
      maxlength="1"
      />
    </div>
    <div class="col">
      <input type="text" oninput='digitValidate(this)' onkeyup='tabChange(3)' class="form-control text-center   @error('reset_code') border-danger @enderror" name="reset_code[]"
      required
      maxlength="1"
      />
    </div>
    <div class="col">
      <input type="text" oninput='digitValidate(this)' onkeyup='tabChange(4)' class="form-control text-center   @error('reset_code') border-danger @enderror" name="reset_code[]"
      required
      maxlength="1"
      />
    </div>
...
<form method="POST" action="{!! route('dashboard.check_sms_code') !!}" class="needs-validation" id="form_sms" novalidate>
    @csrf
    <input type="hidden" name="reset_token" value="hghgmhmgvhjgvgvjhg'">
      <div class="row col-12 col-md-8 m-auto" dir="ltr">
                  <div class="col">
                    <input
