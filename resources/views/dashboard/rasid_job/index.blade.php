  ...
  <div class="col">
    ...
    <div class="row align-items-end mb-3">
        ...
        <div class="col-12 col-md-4">
            ...
            {!! Form::select('is_active', ['' => '', -1 => trans('dashboard.general.all_cases')] + trans('dashboard.rasid_job.active_cases'), old('is_active') ?? request('is_active'), [
    'class' => 'form-control
        select2',
    ...
    'id' => 'status',
        ...
        <div class="col-12 col-md-4">
            ...
            {!! Form::select('is_vacant', ['' => '', -1 => trans('dashboard.general.all_cases')] + trans('dashboard.general.job_type_cases'), old('is_vacant') ?? request('is_vacant'), [
    'class' => 'form-control
        select2',
    ...
    <div class="row">
        ...
        <button class="btn btn-outline-primary" type="button">
            <a href="{{ route('dashboard.rasid_job.index') }}"> <i class="mdi mdi-restore"></i> {{
                trans('dashboard.general.show_all') }}</a>
        </button> --}}
