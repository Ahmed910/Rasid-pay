...
@section('content')
            ...
            <div class="main-container container-fluid">
                ...
                <div class="page-header">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ route('dashboard.group.index') }}"> سجل
                                    الأقسام</a></li>
                ...
                <div class="card py-7 px-7">
                    <div class="row">
                        ...
                        <div class="col-12 col-md-4">
                            ...
                            <p class="text-muted">
                                {!! isset($group->parent->name) ? $group->parent->name : '' !!}</p>
                        </div>
                        <div class="col-12 col-md-4">
                            <label class="d-block" for="groupName">الحالة:</label>
                        ...
                        <div class="col-12 col-md-4">
                            ...
                            <img src="{{ asset("{$group->images[0]->media}") }}" width="150" height="150"
                                class="d-block rounded-3" alt="" data-toggle="popoverIMG" title='<img src="{{ asset("{$group->images[0]->media}") }}" width="150" height="150" class="d-block rounded-3" alt=""
                                        data-toggle="popoverIMG" >'>
                        </div>
                        <div class="col-12 col-md-8">
                            <label class="d-block" for="groupName">الوصف:</label>
                            <p class="text-muted">
                                {!! $group->description !!}
                            </p>
                        </div>
                ...
                <div class="row">
                    <div class="col-12 text-end">
                        <a href="{{ route('dashboard.group.edit', $group->id) }}" class="btn btn-primary">
    ...
    <!--app-content closed-->
@endsection
@include('dashboard.group.show-script')
