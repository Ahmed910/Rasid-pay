...
return [
    ...
    "user_banned" => "{$hotline} هذا الحساب معطل . برجاء التواصل مع الدعم الفني",
    "user_temp_banned" => "هذا الحساب معطل من :ban_from إلى :ban_to . {$hotline} برجاء التواصل مع الدعم الفني ",
    ...
    "reset_password" => [
        ...
        'password' => [
            'regex' => 'كلمة المرور يجب ان تحتوي على حروف كبيرة وصغيرة وارقام وعلامات خاصة'
        ]
    ],
    "token" => [
    ...
    "code" => [
        "not_exists" => "رمز التحقق غير صحيح"
    ]
];
