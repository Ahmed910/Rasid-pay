...
return [
    ...
    'vendor_branch' => [
        ...
        'validation' => [
            ...
            'phone' => [
                ...
                'numeric' => 'حقل رقم الجوال ينبغي أن يكون رقماً',
                'digits_between' => 'حقل رقم الجوال ينبغي أن يكون أرقاماً بين :min و :max',
                'starts_with' => 'حقل رقم الجوال ينبغي أن يبدأ بأرقام :values ',
    ...
    'citizen' => [
        ...
        'status' => 'الحالة',
        'enabled_package' => 'البطاقة المفعلة',
        'start_time' => 'تاريخ التسجيل',
        'end_time' => 'تاريخ انتهاء البطاقة',
        'wallet_in_black_list' => 'عفواً,رقم المحفظة خاص بهوية أو إقامة في القائمة السوداء',
    ...
    'vendors' => [
        ...
        "tax_number" => [
            ...
            "unique" => "لا يمكن تكرار الرقم الضريبي لعملاء مختلفين",
        ],
        "commercial_record" => [
